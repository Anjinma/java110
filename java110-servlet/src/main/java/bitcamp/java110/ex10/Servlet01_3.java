...
public class Servlet01_3 extends HttpServlet {
    ...
    public void doGet(
        ...
        Set-Cookie: age=12; Max-Age=60; Expires=Mon, 01-Oct-2018 03:35:14 GMT; Path=/           <== 종료날짜 지정됨
        Set-Cookie: working=true; Max-Age=86400; Expires=Tue, 02-Oct-2018 03:34:14 GMT; Path=/
        Content-Type: text/html;charset=UTF-8
        Content-Length: 141
        Date: Mon, 01 Oct 2018 03:34:14 GMT
         */
