...
public class Servlet06 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 테스트:
        //   => httl://localhost:8888/ex04/servlet06?name=ABC가각
        // 
        //  => URL 주소 창에 파라미터 값으로 한글을 입력해따 하더라도 
        ...
        // => 그런데 톰캣 7 이하에서는 server.xml에 설정을 해 줘야 한글이 깨지지 않는드ㅏ.
        ...
        //
        //
        // 다음은 POST 요청으로 들어온 한글 데이터를 처리할 떄 사용하는 것이다.
