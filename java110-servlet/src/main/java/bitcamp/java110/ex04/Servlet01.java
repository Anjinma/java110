...
public class Servlet01 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        //   httl://localhost:8888/ex04/servlet01?name=aaa&age=10&working
        // 테스트:
...
//  
// - 바이너리 데이터 전송
//  => request-URI에 포함할 수 있는 것은 테스트 이기 때문에
//     바이너리 데이터(이미지,액셀,영상 등) 를 전송하는데 적합하지 않다.
//  => 물론 Base64 인코딩을 이용하여 바이너리 데이터를 텍스트 데이터로 변환한 다음에 보냇 수는 있다.
