...
- 빌트인 객체
  ...
  config: ServletConfig          - _jspService()의 로컨 변수
  out: JSPWriter                 - _jspService()의 로컨 변수
  page: Object                   - _jspService()의 로컨 변수
    - 현재 서블릿 객체를 가리킨다. 즉 this이다.
  exception: Throwable           - _jspService()의 로컨 변수
...
application.setAttribute("gendet", "woman");
