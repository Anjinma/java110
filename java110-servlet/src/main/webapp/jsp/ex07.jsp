...
pageEncoding 속성 <!-- 웹브라우저가 아니라 JSP엔진에게 알려주는것 -->
    - JSP엔진에게 JSP파일이 어떤 문자표를 사용하여 인코딩 했는지 알려준다.
    
import 속성
    - 서블릿 클래스에 import 코드를 추가한다.
    - 예1) import 속성에 콤마를 사용하여 여러 import문장을 작성할 수 있따.
           import="java.net.*,java.util.*"
