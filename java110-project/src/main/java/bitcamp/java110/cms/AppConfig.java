...
public class AppConfig {
    ...
    public DataSource dataSource() {  //import javax.sql.DataSource;
        ...
        System.out.println(env.getProperty("jdbc.username"));// env에는 기본 자바 virtualmachine의 환경정보가 들어있기때문에 이름이 같다면 기본 정보를 우선시 한다.
    ...
    @Bean
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource, ApplicationContext appCtx) {// 이 메서드 IoC컨테이너가 호출할거다 우리가 위에 dataSource를 갖다 쓰는게 아니고 컨테이너한테 달라고 하는것이다
        ...
        try {
            ...
            factory.setMapperLocations(appCtx.getResources("classpath:/bitcamp/java110/cms/mapper/**/*Dao.xml"));
...
/*    public static void main(String[] args) {
        ...
        ManagerService m = (ManagerService) iocContainer.getBean(ManagerService.class);
        System.out.println(m.list(1, 5));
