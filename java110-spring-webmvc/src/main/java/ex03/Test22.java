...
@RestController // = @Controller + @ResponseBody   / @RestController 안에 모든것들을 JSON값으로 
...
public class Test22 {
 ...
 // 페이지 컨트롤러에 @RestController 를 붙이면 
    ...
    */
    ...
    /*
    @RestController일 경우 리턴 타입이 String이라면 그대로 출력한다.
    */
    @RequestMapping("m4")
    ...
    */
    ...
    /*@RequestBody를 생략하면 안된다!!
     => 생략하면, 
        ...
        그러나 클라이언트는 JSON 형식으로 데이터를 보내기 때무네
    ...
    */
    ...
    /*
    클라이언트가 보낸 JSON 데이터를 Map 객체에 담을 수도 있따.
    ...
    */
    ...
    public String m9(
        ...
        // 내가 저장할 용도도 쓸 맵객체가 아니라 클라이언트가 보낸걸 보내줘!
        // 이것이 바로 @RequestBody
