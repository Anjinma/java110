...
public class Test25 {
    ...
    //
    @RequestMapping(value="search/{car}/{color}/{auto}/{year}", produces="text/plain;charset=UTF-8")
    public String m1(
            @PathVariable String car,
            @PathVariable String color,
            @PathVariable boolean auto,
            @PathVariable int year,// 위 {} 안의 이름과 같게 설정해준다
    ...
    //테스트
    //      http://localhost:8888/app/ex03/test25/search/car=sonata;color=red;auto=true;year=2013
    /*
     @MatrixVariable 애노테이션을 사용하려면 스프린 설정에서 활성화시켜야 한다.
     1) XML 설정
    ...
    */
     ...
     */    
    @RequestMapping(value="search3/model/{value1}/spec/{value2}", produces="text/plain;charset=UTF-8")
    public String m3(
            /*PathVariable이 다르더라도
    ...
    /*
    테스트
       .../search4/car/model=sonata;year=2013/tire/model=BITTIRE;year=2016
    */    
  ...
  public String m5(@PathVariable String l1,
