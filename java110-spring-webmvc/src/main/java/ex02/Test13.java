...
public class Test13 {
    ...
    // 클라이언트가 보낸 파라미터 값을 메서드에 파라미터로 받기
    // 
    ...
    public String m1(
            ...
            @RequestParam("tel") String tel,        // value는 생략 가능.
            Model model) {     
    ...
    // 주의!
    // 파라미터 타입이 String이 아닌 경우, null을 다른 타입으로 바꿀 수 없기 떄문에
    // 오류가 발생한다.
    /*
