...
public class Test02_p3 {
    ...
    static class Member {
        ...
        @Override // 요러케 오버라이딩 해주쟝!~!~!~!~!@_@%_%^_^$_$&_&%_%@_@!_!
        public int hashCode() {
    ...
    public static void main(String[] args) {
        ...
        if(obj1==obj2) //인스턴스는 다르지만!
            System.out.println("obj1==obj2");
        else 
            System.out.println("obj1!=obj2");

        if(obj1.equals(obj2)) // 값은 같다!
            System.out.println("obj1==obj2");
        else 
            System.out.println("obj1!=obj2");
        ...
        //Set은 같은 값을 중복해서 저장하지 않는다.
        // => 즉 인스턴스가 같은지를 비교하는 것이 아니라 값이 같은지를 비교한다.
        // => 또한 HashSet은 이름 그대로 인스턴스의 hash값이 같은지를 비교한다.
        //
        // 주의!
        ...
        //    String 클랫 외에 Wrapper 클래스도 마찬가지이다.
