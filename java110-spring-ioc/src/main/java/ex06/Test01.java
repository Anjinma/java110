...
public class Test01 {
    public static void main(String[] args) {
        ...
        // 주의!
        // <bean> 태그에 class속성만 있다고 해서
        // class 속성에 지정된 클래스의 객체가 생성되어 보관되는 것은 아니다.
        // 그 클래스가 FactoryBean 인터페이스를 구현한 크랠스인 경우
        // 그 객체에 대해 getObject() 리턴값이 보관되는 것이다.
        
        // 문제는 설정할 떄 태그의 모양이 일반 객체와 같ㄷ다는 것이다.
        // 예) <bean id="e4" class="ex06.EngineFactory3">
        //          <property name="model" value="H100"/>
        //      </bean>
        //
        // 그래서 FactoryBean 인터페이스를 구현해서 공장 클래스를 만들 떄는
